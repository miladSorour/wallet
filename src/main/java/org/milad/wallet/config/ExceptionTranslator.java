...
import org.milad.wallet.common.UtilHeader;
import org.milad.wallet.exception.BadRequestAlertException;
import org.milad.wallet.exception.ErrorConstants;
import org.milad.wallet.exception.FieldErrorVM;
import org.milad.wallet.exception.ProblemDetailWithCause;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private HttpStatus getMappedStatus(Throwable err) {
        ...
        if (err instanceof AbstractThrowableProblem) return HttpStatus.valueOf(((AbstractThrowableProblem) err).getStatus().getStatusCode());
        return null;
    }
